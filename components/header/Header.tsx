...
export const Header = () => {
  return (
    <header className="w-full h-screen  relative ">
      <div className="absolute w-full h-full bg-[#36508C]/50 z-40"></div>
      <div className="w-full h-screen text-star  flex flex-row justify-center items-center gap-2 absolute px-[8.5rem] ">
        <div className="w-[30rem]  h-full flex flex-col justify-center  gap-14 ">
          <div className="flex flex-col gap-2 z-40">
            <h1 className="text-4xl font-bold text-white">
              <p>Prueba de cambio </p>
            </h1>
            <p className="text-white font-semibold ">
              Registel se especializa en solucionar a través de tecnología la
              necesidad de monitorear y contabilizar las personas que ingresan
              al sistema de transporte público o establecimientos que lo
              requieran.
            </p>
          </div>
        ...
        <div className="w-[30rem] h-dull z-50 bg-blue-500 "></div>
      </div>
      <div></div>

      <Image
        src={inicio}
        alt="Imagen de fondo, con plaqueta de componentes electronicos y cautin"
        layout="fill"
        objectFit="cover"
      />
    </header>
