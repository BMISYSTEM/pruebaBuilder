    ...
    <section className="w-full flex flex-row gap-5 px-[8.5rem]">
        ...
        <div className='w-full flex flex-row '>
            <div className='w-full flex flex-row items-center justify-end text-white ' >
                <button className='w-10 h-10 cursor-pointer bg-[#C8E4F1] rounded-full flex items-center justify-center'>
                ...
                <button className='w-10 h-10 bg-[#C8E4F1] cursor-pointer rounded-full flex text-white items-center justify-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <div className='w-2/3 flex-col gap-3 z-40 '>
                {/* mensaje */}
                <div className='w-full h-30 bg-[#BBDEEE] rounded-2xl p-2 ml-[-8rem] mt-12'>
                ...
                <div className='w-1/3 flex flex-col gap-2 text-end '>
                    <p className='text-5xl font-extrabold text-[#BBDEEE]'>Jairo</p>
                    <p className='text-xl font-extrabold text-[#BBDEEE]'>Valero</p>
                </div>
            </div>
        </div>
    </section>
